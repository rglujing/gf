...
import (
	...
	"github.com/rglujing/gf/internal/empty"
	"github.com/rglujing/gf/internal/json"
	"github.com/rglujing/gf/internal/utils"
	"github.com/rglujing/gf/os/gtime"
	"github.com/rglujing/gf/util/gmeta"
	"github.com/rglujing/gf/util/gutil"

	"github.com/rglujing/gf/internal/structs"
		...
		if value == nil || empty.IsNil(rv) {
			...
			if gstr.Pos(quotedKey, "?") == -1 {
				...
				if len(quotedKey) > len(like) && gstr.Equal(quotedKey[len(quotedKey)-len(like):], like) {
					...
					// Issue: https://github.com/rglujing/gf/issues/765
